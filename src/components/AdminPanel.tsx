...
function AdminDashboard({ onNavigate }: { onNavigate: (tab: 'players' | 'fixtures' | 'predictions', filter?: 'upcoming' | 'completed' | 'all') => void }) {
...
function AdminPredictionsDashboard() {
                        ...
                        <>
                          ...
                          <td className="py-3 px-4 text-center">
                            <span className={`font-bold text-sm ${
                              (pred.points_won || 0) > 0 ? 'text-yellow-400' : 'text-slate-500'
                            }`}>
                              {pred.points_won ?? '—'}
                            </span>
                          </td>
...
export default function AdminPanel({
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'players' | 'fixtures' | 'competitions' | 'backups' | 'communications' | 'leagues' | 'predictions'>('dashboard');
        ...
        <div className="flex flex-col h-[78vh]">
          ...
          <div className="bg-slate-950 px-5 py-2.5 border-b border-slate-800 flex items-center justify-between">
            ...
            <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6 bg-slate-900/30">
              ...
              {activeTab === 'predictions' && <AdminPredictionsDashboard />}
