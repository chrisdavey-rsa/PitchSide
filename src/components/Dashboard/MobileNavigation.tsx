  ...
  return (
    ...
    >
      <div className="relative flex items-end justify-between px-1 pt-2 pb-2 max-w-lg mx-auto">
        ...
        <div
          data-tour="mobile-predictions"
          className="relative flex-1 flex justify-center -mt-5"
        >
          <button
            type="button"
